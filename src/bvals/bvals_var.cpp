...
BoundaryVariable::BoundaryVariable(MeshBlock *pmb, bool fflux) :
  ...
  flip_across_pole_hydro[0] = false;
  flip_across_pole_hydro[1] = false;
  flip_across_pole_hydro[2] = true;
  flip_across_pole_hydro[3] = true;
  if (NON_BAROTROPIC_EOS) {
    flip_across_pole_hydro[4] = false;
    if (DUAL_ENERGY_ENABLED) {
      flip_across_pole_hydro[NHYDRO-1] = false;
    }
  }
}
