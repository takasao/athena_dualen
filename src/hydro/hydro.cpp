...
Hydro::Hydro(MeshBlock *pmb, ParameterInput *pin) :
  ...
  // START:: For dual energy formalsim
  ...
  hydro_dualenfunc_defined = false;
  UserDualEnergy = pmy_block->pmy_mesh->UserDualEnergy_;
  if (UserDualEnergy != nullptr) hydro_dualenfunc_defined = true;

  // END:: For dual energy formalism
}
