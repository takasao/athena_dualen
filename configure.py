...
# -dual_en argument
parser.add_argument('-dual_en',
                    action='store_true',
                    default=False,
                    help='enable dual energy formalism')

# --dual_en_flag=[value] argument
parser.add_argument('--dual_en_flag',
                    default='1',
                    help='set flag for dual energy formalism')

# -test_dual_en argument
parser.add_argument('-test_dual_en',
                    action='store_true',
                    default=False,
                    help='use non-conservative internal energy')
...
if args['eos'] == 'isothermal':
    ...
    definitions['DUAL_ENERGY_ENABLED'] = '0'
elif args['eos'] == 'adiabatic':
    definitions['NHYDRO_VARIABLES'] = '5'
    definitions['DUAL_ENERGY_ENABLED'] = '0'
    if args['dual_en']:
        definitions['NHYDRO_VARIABLES'] = '6'
        definitions['DUAL_ENERGY_ENABLED'] = '1'
else:
...
# --dual_en_flag=[value] argument
definitions['DUAL_ENERGY_FLAG'] = args['dual_en_flag']
...
print('  Dual energy:                ' + ('ON' if args['dual_en'] else 'OFF'))
print('  Type of dual energy:        ' + (args['dual_en_flag']))
